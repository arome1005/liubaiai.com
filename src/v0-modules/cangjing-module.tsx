...
import { MOCK_REFERENCE_BOOKS, type MockReferenceBook } from "../data/reference-library-mock"

type ReferenceBook = MockReferenceBook
const mockBooks = MOCK_REFERENCE_BOOKS
