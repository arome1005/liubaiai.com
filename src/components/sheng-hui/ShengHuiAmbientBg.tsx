/** 与创作中心「用量洞察」同级的轻量氛围底，不抢主稿。含 SVG 噪点 + `paper-grain.png` 叠层（N8）。 */
export function ShengHuiAmbientBg() {
  return (
    <div className="pointer-events-none absolute inset-0 overflow-hidden" aria-hidden>
      ...
      />
      <div
        className="absolute inset-0 bg-[url('/images/paper-grain.png')] bg-[length:256px] opacity-[0.04] mix-blend-overlay dark:opacity-[0.06]"
        aria-hidden
      />
